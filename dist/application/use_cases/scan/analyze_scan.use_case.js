...
exports.AnalyzeScanUseCase = void 0;
const tsyringe_1 = require("tsyringe");
const auth_error_1 = require("../../../domain/errors/auth.error");
let AnalyzeScanUseCase = class AnalyzeScanUseCase {
    userRepository;
    aiService;
    cloudinaryService;
    constructor(userRepository, aiService, cloudinaryService) {
        this.userRepository = userRepository;
        this.aiService = aiService;
        this.cloudinaryService = cloudinaryService;
    }
    async execute(firebaseUid, scanType, base64Image, additionalContext) {
...
exports.AnalyzeScanUseCase = AnalyzeScanUseCase;
exports.AnalyzeScanUseCase = AnalyzeScanUseCase = __decorate([
    (0, tsyringe_1.injectable)(),
    __param(0, (0, tsyringe_1.inject)('IUserRepository')),
    __param(1, (0, tsyringe_1.inject)('IGenerativeAiService')),
    __param(2, (0, tsyringe_1.inject)('ICloudinaryService')),
