...
exports.AnalyzeFoodUseCase = void 0;
...
let AnalyzeFoodUseCase = class AnalyzeFoodUseCase {
    userRepository;
    chatRepository;
    scanRepository;
    aiService;
    constructor(userRepository, chatRepository, scanRepository, aiService) {
        this.userRepository = userRepository;
        this.chatRepository = chatRepository;
        this.scanRepository = scanRepository;
        this.aiService = aiService;
    }
    async execute(firebaseUid, sessionId, prompt, base64Image, scanHistoryId) {
...
exports.AnalyzeFoodUseCase = AnalyzeFoodUseCase;
exports.AnalyzeFoodUseCase = AnalyzeFoodUseCase = __decorate([
    (0, tsyringe_1.injectable)(),
    __param(0, (0, tsyringe_1.inject)('IUserRepository')),
    __param(1, (0, tsyringe_1.inject)('IChatRepository')),
    __param(2, (0, tsyringe_1.inject)('IScanRepository')),
    __param(3, (0, tsyringe_1.inject)('IGenerativeAiService')),
